...
class WardDomain(BaseDomain):
    ...
    def __init__(self,y_dim=2):
        ...
        self.static_names = ['age', 'floor: MP2 MPU PR',
            'floor: MP2 PERIOPERATIVE AREA', 'floor: RR 3F', 'floor: RR 5DR',
            'floor: RR 5EMS', 'floor: RR 5EOB', 'floor: RR 5FDU IOF',
            'floor: RR 5PICU', 'floor: RR 5W', 'floor: RR 6E', 'floor: RR 6ICU',
            'floor: RR 6N', 'floor: RR 6W', 'floor: RR 7E', 'floor: RR 7ICU',
            'floor: RR 7N', 'floor: RR 7W', 'floor: RR 8E', 'floor: RR 8N',
            'floor: RR 8W', 'floor: RR GOU', 'floor: RR MPU',
            'floor: RR PACU BOARDING', 'floor: RR PERIOPERATIVE AREA',
            'floor: RR TRU 2WEST', 'floor: SM 4SW', 'gender',
            'ethnicity: Hispanic or Latino',
            'ethnicity: Hispanic/Spanish origin Other',
            'ethnicity: Mexican, Mexican American, Chicano/a',
            'ethnicity: Not Hispanic or Latino', 'ethnicity: Patient Refused',
            'ethnicity: Puerto Rican', 'ethnicity: Unknown',
            'race: American Indian or Alaska Native', 'race: Asian',
            'race: Black or African American', 'race: Multiple Races',
            'race: Native Hawaiian or Other Pacific Islander', 'race: Other',
            'race: Patient Refused', 'race: Unknown', 'race: White or Caucasian',
